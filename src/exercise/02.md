...
The biggest revelation I had from this exercise is the difference between
`React` and `ReactDOM`. `React` is responsible for creating React elements, and
`ReactDOM` is responsible for rendering React elements as regular HTML elements
in the DOM.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=yost90%40gmail.com).
