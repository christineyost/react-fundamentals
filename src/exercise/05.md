...
- To specify multiple class names for a React element simply seperate them with
  a space in a single `className` attribute
- The style element in JSX is an object containing CSS properties
- With class names it can be nice to specify more generic properties and infer
  the specific class name in the component itself (for example: small, medium,
  large)
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=05%3A%20Styling&em=yost90%40gmail.com).
